          ...
          child: Column(
            children: <Widget>[
              ...
              Container(
                ...
                child: Column(
                  children: <Widget>[
                    quizEditTextStyle(quiz_hint_First_name, TextInputType.text, isPassword: false),
                    quizDivider(),
                    quizEditTextStyle(quiz_hint_Last_name, TextInputType.text, isPassword: false),
                    quizDivider(),
                    quizEditTextStyle(quiz_hint_Mobile_Number, TextInputType.number, isPassword: false),
                  ],
                ),
              ),
              SizedBox(height: 20),
